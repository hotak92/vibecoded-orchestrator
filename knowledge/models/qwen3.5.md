...
- **Install bootstrap**: `install.py` does not pull Qwen3.5 by default — it ships the embedding models and `qwen3.5:0.8b` for fast local inference, leaving the user to pull the larger Qwen3.5 variant matching their hardware (`ollama pull qwen3.5:9b`).
