...
Local analysis tasks (rewriting docstrings, summarizing files, extracting info) use the Ollama MCP (`chat`, `read_document`) which is FREE and doesn't consume Claude API tokens.
