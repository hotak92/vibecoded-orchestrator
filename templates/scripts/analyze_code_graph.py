...
class CodeGraphAnalyzer:
    ...
    # instance for the vco_lib/codegraph_lang extractor modules.
    #
    # The per-language extractors moved out of this file and receive this
    # analyzer instance as ``ctx``. Four of their dependencies STAY here
    # as module globals — ``embed_function`` / ``embed_class`` /
    # ``generate_embedding`` / ``_shape_for_insert`` — because they are
    # shared with non-extractor code in this file and sit on the
    # embedding-service module state (``_embedding_service`` /
    # ``DUAL_EMBEDDING_ENABLED``). Each delegator resolves the module
    # global LATE, by bare name at call time (a method body's name
    # resolution goes local → module → builtins and never the class, so
    # this does NOT recurse). Late lookup keeps the long-standing test
    # seam intact: monkeypatching ``analyzer_mod.embed_*`` /
    # ``analyzer_mod.generate_embedding`` / ``analyzer_mod
    # ._shape_for_insert`` governs the moved extractors exactly as it
    # governed the inline ones (tests/test_codegraph_lang_scaffold.py
    # pins this).
    def embed_function(self, *args, **kwargs):
        return embed_function(*args, **kwargs)

    def embed_class(self, *args, **kwargs):
        return embed_class(*args, **kwargs)

    def generate_embedding(self, *args, **kwargs):
        return generate_embedding(*args, **kwargs)

    def _shape_for_insert(self, *args, **kwargs):
    ...
    def _analyze_csharp_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        ...
        vco_lib/codegraph_lang/csharp.py::analyze_csharp_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["csharp"](self, file_path, repo_root)

    def _analyze_proto_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/proto.py::analyze_proto_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["proto"](self, file_path, repo_root)

    def _analyze_js_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/javascript.py::analyze_js_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["javascript"](self, file_path, repo_root)
    ...
    def _analyze_lua_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/lua.py::analyze_lua_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["lua"](self, file_path, repo_root)

    def _analyze_cpp_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/cpp.py::analyze_cpp_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["cpp"](self, file_path, repo_root)

    def _analyze_go_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/go.py::analyze_go_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["go"](self, file_path, repo_root)

    def _analyze_rust_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/rust.py::analyze_rust_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["rust"](self, file_path, repo_root)

    def _analyze_java_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/java.py::analyze_java_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["java"](self, file_path, repo_root)

    def _analyze_ruby_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/ruby.py::analyze_ruby_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["ruby"](self, file_path, repo_root)

    def _analyze_shell_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/shell.py::analyze_shell_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["shell"](self, file_path, repo_root)

    def _analyze_python_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/python.py::analyze_python_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["python"](self, file_path, repo_root)
    ...
    def _analyze_svelte_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/svelte.py::analyze_svelte_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["svelte"](self, file_path, repo_root)

    def _analyze_powershell_file(self, file_path: Path, repo_root: Path) -> Dict[str, int]:
        """P2f stage 2 (v0.2.76): moved verbatim to
        vco_lib/codegraph_lang/powershell.py::analyze_powershell_file — dispatched
        through the codegraph_lang.EXTRACTORS registry."""
        return _codegraph_lang.EXTRACTORS["powershell"](self, file_path, repo_root)
