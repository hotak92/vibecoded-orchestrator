# OS-EXEMPT-PARITY: v0.2.92 fixed PowerShell parsing defects ($Label: scope qualifier inside a here-string) — parsing has no .sh analog; no sibling change required.
