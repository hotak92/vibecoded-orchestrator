...
keywords: [prompt review, prompt optimization, chain-of-thought, few-shot, prompt template, agent prompt, "system prompt", "prompt tuning", "prompt design", "optimize my prompt", "improve this prompt", "prompt for an agent"]
