...
echo ""
echo "This will:"
echo "  - Auto-install Python 3.11+, Node.js 18+, and Podman if missing"
echo "    (interactive prompt before any apt/dnf/pacman/brew invocation)"
echo "  - Auto-start the Podman daemon if installed but stopped"
echo "    (deferral written to UPDATE_DEFERRED.md if start fails)"
echo "  - Detect GPU drivers and print install hints (drivers stay manual)"
