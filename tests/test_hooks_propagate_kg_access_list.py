...
# single source of truth. .claude/hooks/ used to be a byte-identical mirror
# shipped in the repo; install.py now renders it from templates/ at install
# time, so only the template layout is canonical at the git layer.
HOOKS_DIRS = [
